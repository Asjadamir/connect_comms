...
const Section2 = () => {
    return (
        <section className="bg-white">
            <div className="py-10 px-5 container mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                ...
                <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-neutral-100 lg:h-12 lg:w-12">
                            <svg
                                className="w-6 h-6 text-neutral-600 lg:w-6 lg:h-6"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                    ...
                    <div>
                        <div className="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-neutral-100 lg:h-12 lg:w-12">
                            <svg
                                className="w-5 h-5 text-neutral-600 lg:w-6 lg:h-6"
                                fill="currentColor"
                                viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg"
                            >
