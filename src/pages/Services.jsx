...
const Service = () => {
    return (
        <section className="pb-12 pt-10 lg:pb-[90px] font-sans px-5">
            <div className="container mx-auto">
                <div className="-mx-4 flex flex-wrap">
                    <div className="w-full px-4">
                        <div className="mx-auto mb-12 max-w-[510px] text-center lg:mb-20">
                            <span className="mb-2 block text-lg font-semibold text-neutral-500">
                                Our Services
                            </span>
                            <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-neutral-800 sm:text-6xl">
                                What We Offer
                            </h2>
                ...
                <div className="-mx-4 flex flex-wrap">
                    <ServiceCard
                        ...
                        details="We craft comprehensive digital marketing strategies to boost your brand visibility and drive online traffic."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Enhance your website's performance and user experience with our expert optimization services."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="We create engaging content and manage your accounts to increase brand awareness and customer engagement."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        title="Tech Support"
                        details="Our skilled team provides efficient support for various technical issues, ensuring smooth operations for your business."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    <ServiceCard
                        ...
                        details="Our developers create innovative applications to streamline your processes and improve productivity."
                        icon={
                            <svg
                                width="36"
                                height="36"
                    ...
                    />
                    <ServiceCard
                        title="Remote Internship Program"
                        details="We offer hands-on experience and mentorship to students, helping them build valuable skills."
                        icon={
                            <svg
                                width="36"
                                height="36"
    ...
    return (
        <>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="mb-9 rounded-[20px] bg-white p-10 shadow-2 shadow-md hover:shadow-lg xl:px-10">
                    <div className="mb-8 flex h-[70px] w-[70px] items-center justify-center rounded-2xl bg-neutral-700">
                        {icon}
                    </div>
                    <h4 className="mb-[14px] text-2xl font-semibold text-neutral-900">
                        {title}
                    </h4>
